...
String getHTML()
{
  ...
  ptr += ".wrapper-text {padding-top: 60px;}\n";
  ...
  ptr += "<div class='wrapper'>\n";
  ptr += "  <div class='wrapperButton'>\n";
  ptr += "    <p>Tare</p><a id='setBaseAngle' class=\"button button-off\">SET</a>\n";
  ptr += "  </div>\n";
  ptr += "  <div class='middle_gap'>\n";
  ptr += "  &nbsp;\n";
  ptr += "  </div>\n";
  ...
  ptr += "let checkLoop;\n";
  ptr += "const getCurrentAngleZ = generateCallback('getCurrentAngleZ', 'angle');\n";  
  ...
  ptr += "      checkLoop = setInterval(getCurrentAngleZ, 150);\n";
  ptr += "    } else {\n";
